...
procedure.  In Appendix~\ref{app:formal}, we provide the formal definition
of this method for all semantic expressions and \glspl{mir} by extending
the optimization function $\optfunc{e}\sigma^\sharp$ proposed in
