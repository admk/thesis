...
\newcommand{\subfigsize}{0.32}
\begin{figure*}[!ht]
    \centering
    \subfigure[Optimization of ${(a + b)}^2$]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]{martel}
        \label{fig:martel}
    }%
    \subfigure[Simultaneous optimization of both $e_x$ and $e_y$]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]%
            {multi_expr_32}
        \label{fig:multi_expr_32}
    }%
    \subfigure[Varying the mantissa width of (b)]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]%
            {multi_expr_vary_width}
        \label{fig:multi_expr_vary_width}
    }
    \subfigure[The Taylor expansion of $\sin(x + y)$]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]{taylor_sin}
        \label{fig:taylor_sin}
    }%
    \subfigure[The Motzkin polynomial $e_m$]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]{motzkin}
        \label{fig:motzkin}
    }%
    \subfigure[Accuracy of Area Estimation]{
        \includegraphics[scale=\subfigsize, trim=20pt 0pt 5pt 0pt]{area}
        \label{fig:area}
    }%
