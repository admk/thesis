...
Furthermore, from a function $g: \mathsf{L} \to \mathsf{L}$, the AI framework
allows an approximated function $g^\sharp: \mathsf{M} \to \mathsf{M}$ to
be inductively abstracted by the Gal\"ois connection~\cite{nielson99}.
