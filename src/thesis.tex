...
\include{stropt/related_work}
\include{stropt/abstract_interpretation}
\include{stropt/semantics}
\include{stropt/implementation}
\include{stropt/results}
\include{stropt/conclusion}
...
\include{progopt/related_work}
\include{progopt/syntax}
\include{progopt/metasemantics}
\include{progopt/transformations}
\include{progopt/code_generation}
\include{progopt/results}
\include{progopt/conclusion}
...
\include{latopt/motivation}
% \include{latopt/overview}
% \include{latopt/intermediate}
% \include{latopt/transform}
% \include{latopt/analysis}
% \include{latopt/usage}
% \include{latopt/results}
% \include{latopt/related_work}
% \include{latopt/conclusion}
